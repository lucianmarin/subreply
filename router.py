...
app.add_route('/discover/replies', resources.DiscoverResource(), suffix="re")
...
app.add_route('/trending/new', resources.TrendingResource(), suffix="new")
app.add_route('/trending/old', resources.TrendingResource(), suffix="old")
